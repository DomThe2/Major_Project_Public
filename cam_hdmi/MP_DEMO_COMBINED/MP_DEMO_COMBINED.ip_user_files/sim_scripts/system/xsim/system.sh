...
#
# Script generated by Vivado on Mon Apr 20 16:58:17 +0100 2026
...
export RDI_DATADIR="C:/AMDDesignTools/2025.2/Vivado/data"
...
# script info
echo -e "system.sh - Script generated by export_simulation (Vivado v2025.2 (64-bit)-id)\n"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L proc_sys_reset_v5_0_17 -L axis_infrastructure_v1_1_1 -L axis_data_fifo_v2_0_17 -L xlconstant_v1_1_10 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot system xil_defaultlib.system xil_defaultlib.glbl -log elaborate.log
}
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="C:/AMDDesignTools/2025.2/Vivado/data/xsim"
  fi
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb system.wdb xsim.dir libdpi.so)
...
Usage: system.sh [-rerun]\n\
Usage: system.sh [-reset_run]\n\
Usage: system.sh [-clean]\n\
