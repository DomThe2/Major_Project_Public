...
HD_PWD='C:/Users/binns/Desktop/MP/HDMI_P/project_1/project_1.runs/system_rgb2dvi_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_rgb2dvi_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_rgb2dvi_0_0.tcl
